...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle">QA Analyst, Developer and Accountant</h3>
        <p className="home__description">I'm a technology lover based in Barranquilla, and I'm very passionate and dedicated to my work.</p>
